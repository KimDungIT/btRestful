...
public class ComposerSpecification implements Specification<Composer> {
    ...
    @Override
    public Predicate toPredicate(Root<Composer> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
